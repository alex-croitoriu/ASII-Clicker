...
const UpgradeComponent = () => {
  ...
  if (loading) {
    return <div className="w-full mt-auto bg-gray-800">
      <div className="bg-gray-600 h-40 mb-6 rounded-3xl mx-6 p-2"><div>Loading...</div></div></div>;
  }
      ...
      <div className="bg-gray-600 h-40 mb-6 rounded-3xl mx-6 p-2">
        ...
        >
          {Object.entries(upgradeTrees).map(([index, value]) => {
            return <SwiperSlide key={value._id}>
