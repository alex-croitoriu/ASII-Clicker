export default function Page() {
    return (
        <div className=" bg-gray-800 mt-8 flex flex-col gap-8 pb-8">
            <div className="max-w-5xl mx-auto rounded-3xl bg-gray-600 px-6 py-4">
            ...
            <div className="max-w-5xl w-full mx-auto rounded-3xl bg-gray-600 px-6 py-4">
                <h1 className="text-3xl font-semibold flex gap-2 items-center">
                    <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
