...
export default function Page() {
    ...
    const data = [
        {
            rating: 5,
            author: "Steve Jobs",
            message: "This game cured my depression",
        },
        {
            rating: 4,
            author: "Terry A. Davis",
            message: "Stupid idea, genius execution. I love it!",
        },
        {
            rating: 1,
            message: "I can\'t play it on my Samsung Galaxy J5 2015 so I\'m leaving a bad review.",
        },
        {
            rating: 5,
            author: "Linus Torvalds",
            message: "I stopped developing Linux just to play this game. Best decision ever.",
        },
        {
            rating: 4,
            author: "Elon Musk",
            message: "I wasted hours on this and regret nothing.",
        },
        {
            rating: 1,
            author: "Donald Trump",
            message: "Terrible! The worst game ever made. Should’ve been huge, but it's not. Sad!",
        },
        {
            rating: 4,
            author: "Klaus Iohannis",
            message: "It’s pretty good. I grinded tons of frameworks to afford my 6 houses.",
        },
        {
            rating: 5,
            author: "ThePrimeagen",
            message: "This game is almost as addictive as Vim config files. 10/10, would rage quit again.",
        },
    ]
    ...
    const handleSubmit = (rating, name, message) => {
    ...
    return (
        <div className="bg-gray-800 flex flex-col gap-5 md:gap-7 lg:gap-8 p-5 md:p-7 lg:p-8">
            <div className="max-w-5xl container mx-auto grid grid-cols-3 gap-x-8 gap-y-4 text-[17px]">
                    ...
                    <div key={i} className="rounded-3xl bg-gray-600 px-4 py-3 flex flex-col items-center justify-between gap-2">
                        <div className="flex flex-col items-center">
                            <div className="flex gap-0.5 justify-center">
                                {[...Array(testimonial.rating)].map((a, b) =>
                ...
                <button 
                    className="outline-none rounded-3xl bg-gray-600 px-4 py-3 flex items-center gap-1 justify-center text-xl hover:opacity-85 transition font-semibold"
