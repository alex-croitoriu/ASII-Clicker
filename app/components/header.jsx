...
export default function Header() {
	...
	return (
		<div className="grid grid-cols-3 items-center text-lg lg:text-xl font-semibold pt-4 px-10 lg:px-14 relative z-10">
			...
			<div className="flex justify-self-center">
				<h1 className="text-2xl lg:text-3xl font-medium text-center leading-6 whitespace-nowrap">
