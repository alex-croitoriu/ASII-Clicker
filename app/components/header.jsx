...
import { Menu, MenuButton, MenuItems, MenuItem, MenuBackdrop } from '@headlessui/react'
		...
		<div className="grid grid-cols-3 items-center text-lg lg:text-xl font-semibold pt-2 lg:pt-4 px-6 md:px-10 lg:px-14 relative z-10">
			<div className="flex md:hidden">
                <Menu as="div" className="flex items-center relative">
					...
					<MenuItems 
						as="div" 
						className="origin-top transition ease-out data-[closed]:opacity-0 flex flex-col md:hidden absolute outline-none px-5 pb-8 w-full rounded-3xl"
						transition
						anchor="bottom"
					>
						<div className="flex flex-col items-center bg-gray-600 rounded-3xl mt-4 px-4 py-3 shadow-xl relative text-white font-semibold text-[17px]">
							<MenuItem as="div">
							<div className="flex flex-col gap-3 items-center">
								<Link href="https://www.asii.ro/" target="_blank" className="w-fit">
									<svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 725.65 409.77" className="w-16 fill-white hover:fill-yellow-primary transition">
			...
			<div className="col-start-3 flex md:hidden items-center justify-end mr-4 gap-10">
				<div className="flex flex-col items-center text-sm leading-4">
					...
					<span className="text-[15px] font-semibold"> FPS </span>
				</div>
				<div className="flex flex-col items-center text-sm leading-4">
					<span>
						{frameworksPerClick.toLocaleString('en-US', {
					...
					<span className="text-[15px] font-semibold"> FPC </span>
				</div>
			</div>
