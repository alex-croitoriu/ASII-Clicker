...
const UpgradeComponent = () => {
	...
	const { frameworks, upgradeStats } = useFrameworkStore()
	...
	const icon = (upgradeTreeName) => {
		return {
			'Code Editor': `<svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			'Package Manager': `<svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			'Operating System': `<svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			'Debugging Technique': `<svg width="24px" height="24px" version="1.1" id="Icons" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 32 32" xml:space="preserve">
					<style type="text/css">
			...
			'Vulnerability Patching': `<svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
